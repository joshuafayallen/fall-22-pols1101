...
are those evaluations that depend on some intermediary; for example, I need the media to provide me with information about the macroeconomy, but I can also use my SREs to make mediated judgments (e.g. I can use my experience with personal finance to make judgments about the national economy). MREs are mediated by a citizen's choice of information sources and opinion leaders.
...
the dark grey bars are the validated vote share.
