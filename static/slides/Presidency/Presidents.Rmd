...
- Absolute majority to win
  - presently 270 to win 
  
- What are some of the problems?


???
Small states have relatively more political power. Just take the total population and divide 

The contingency plan really really sucks. Remember each delegation gets one vote 


The whole issue of being a democracy 
...
```{r}
knitr::include_url("https://usafacts.org/visualizations/electoral-college-states-representation/")
```
...
???
Head of state: they are the symbolic representation of the United states. They do cute little things like welcoming diplomats or greeting the championship winning teams. 

Chief Executive: The President is also chief executive, vested by the Constitution with broad executive powers. This power is used at home on domestic issues and also extends to foreign affairs. The executive power is limited, however, by our government’s system of checks and balances.


Chief Legislator	As chief legislator, the President shapes public policy. The President may suggest, request, and insist that Congress enact laws he believes are needed. Sometimes, Congress does not agree with the President and decides against legislation. Working with Congress takes up a major part of the President’s time. It is more in the sense that they sort of steward things 
...
```{r}
vembedr::embed_url("https://www.youtube.com/watch?v=Q3YhruUmPAM&t=3s")
```
...
---
## Different Types of Bureacratic Organizations 
...
```{r}
vembedr::embed_url("https://youtu.be/nVPMeoGGhcg")
```
